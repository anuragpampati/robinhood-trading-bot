...
- SUMMARY: Market OPEN (15:25 ET). No trades — buying power $50.40 ($0.40 above $50 buffer; min order $15 — insufficient). 0 RSI BUY, 0 net-buy BUY, 0 intraday-surge candidates. 1 equity position (GOOGL). Regime: normal (BULLISH). Account: $97.82.
- Sells: None — GOOGL $345.79 (+0.84%), trail_stop $338.18 (OK), take_profit $377.21 (not reached), signal=HOLD, hours_held ~26h.
- Buys: None — buying_power $50.40 − $50 buffer = $0.40 usable (< $15 min order). No RSI/net-buy BUY signals.
- ATR stop: profit_pct +0.84% < 2.5% — trail_stop unchanged at $338.18.
- RSI SELL (not held): QQQ(RSI=70.8 ABOVE_BAND), HOOD(RSI=73.0 ABOVE_BAND), SBUX(RSI=70.8 ABOVE_BAND), LRCX(RSI=74.9 ABOVE_BAND), SHOP(RSI=71.7 ABOVE_BAND), GEV(RSI=70.3 ABOVE_BAND), ASML(RSI=77.1 ABOVE_BAND).
- Net-buy SELL (not held): RKLB, PFE, AVAV, NVDA, BA.
- Surge: UUUU +6.48% (below 10% tracker threshold; no intraday-surge entry). SHOP removed from tracker (no longer in surge signals).
