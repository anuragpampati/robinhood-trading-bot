...
- SUMMARY: Market OPEN (15:17 ET). NO TRADES. REGIME: NORMAL (SPY $764.81 > EMA200 $762.37). 3 RSI BUY: PLTR RSI=27.1 (conf=2, rl=HOLD 0.906), SNOW RSI=28.9 (conf=2, rl=HOLD 0.906), MRCY RSI=26.2 (conf=2, rl=HOLD 0.906) — all skipped: buying power ($64.48) − $50 buffer = $14.48 available < $15 min order. 0 net-buy BUY signals. SURGE: IREN buy_surge_pct=61.8% (count=1, needs 2); MU removed from tracker (not in 10%+ surge this cycle). No sell triggers on PYPL or HOOD. ATR trail stops: PYPL $54.23 > $51.87 (OK, +0.76%), HOOD $106.35 > $101.86 (OK, +0.66%). No ratchet (both < 2.5% profit). Take-profit: PYPL $54.23 < $59.20, HOOD $106.35 < $116.22. Net-buy SELL: CRDO, SOUN, RKLB, AMD, VRT, COHR, AAOI, TXN, AVGO, LITE (none held). Circuit breaker INACTIVE (daily +0.27%, weekly +0.84%). Buying power: $64.48. 2 positions: PYPL $54.23 (+0.76%, stop=$51.87), HOOD $106.35 (+0.66%, stop=$101.86). Account: $94.70.
