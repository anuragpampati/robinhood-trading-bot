...
- LRCX: 0.140528 shares @ $334.45 → $343.98 (+2.85%). Trail stop: $336.12. Target: $367.90. No sell triggered (price > trail_stop, no signal SELL, TP=$367.90 not hit).
- NO BUYS: BP $50.75 − $50 buffer = $0.75 usable < $15 min order. Candidates skipped: LRCX (already held), MRCY (net-buy 4d, $50 req — insufficient capital).
- Surge tracker RESET (new day): LRCX count=1, MRCY count=1, IONQ removed. No intraday surge buy candidates (need count≥2).
- RSI SELL (not held): CVX(RSI 72.0 ABOVE_BAND), TER(RSI 76.6 ABOVE_BAND), LAZR(RSI 70.8 ABOVE_BAND).
- Net-buy SELL (not held): UBER, ALAB, AVAV, ASTS, GM, RDW, TXN, SNOW, CRWV, META.
- CB: INACTIVE | daily 0.0% (new day) / weekly -2.09% ($97.75→$95.71). Peak: $101.68.
